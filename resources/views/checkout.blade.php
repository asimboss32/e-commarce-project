                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <div style="background: lightgrey;padding: 10px;">
                                        <input type="radio" id="outside_dhaka" name="area" onclick="grandTotalOut()" value="150"/>
                       ...
                       @endforeach
                        <div class="sub-total-wrap">
                            <div class="sub-total-item">
                                ...
                                <input type="hidden" id="subTotalHidden" name="subTotalHidden" value="{{$subTotal}}">
                            </div>
                            <div class="sub-total-item">
                            ...
                            <div class="sub-total-item grand-total">
                                 ...
                                 <input type="hidden" name="grandTotalHidden" value="{{$subTotal+80}}" id="grandTotalHidden">
                            </div>
                        </div>
