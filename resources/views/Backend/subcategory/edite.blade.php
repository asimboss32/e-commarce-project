                        ...
                        <div class="card card-primary">
                            ...
                            <form action="{{url('/admin/Sub-Category/Update/'.$subcategory->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <option value="{{$category->id}}" @if ($category->id == $subcategory->cate_id)
                                        selected
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" value="{{$subcategory->name}}" name="name" placeholder="Enter Name*" required>
                                    </div>
                                </div>
                                <!-- /.card-body -->
